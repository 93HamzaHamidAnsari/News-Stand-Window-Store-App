...
namespace News_Stand
{
    ...
    public sealed partial class health : Page
    {
        ...
        private void open(object sender, RoutedEventArgs e)
        {
            ...
            {
                new grid_clas{image="Assets/bbc_health.jpg",desc="BBC Health"},
                new grid_clas{image="Assets/new_york_times_health.jpg",desc="The New York Times Health"}
                
            };
         health_grid.DataContext = m;
        }
        //end of grid
