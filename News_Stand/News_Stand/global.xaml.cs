...
namespace News_Stand
{
    ...
    public sealed partial class global : Page
    {
        ...
        private void open(object sender, RoutedEventArgs e)
        {
            ...
            {
                new grid_clas{image="Assets/top.jpg",desc="Top Stories"}
                
                
            };
            gloabl_main_grid.DataContext = m;
        }
        //end of 1st grid

        //start of 2nd grid
        private void when_open(object sender, RoutedEventArgs e)
        {
            List<grid_clas> m = new List<grid_clas>()
            {
                new grid_clas{image="Assets/world.jpg",desc="World"},
                 new grid_clas{image="Assets/europe.jpg",desc="Europe"},
                 
                  new grid_clas{image="Assets/tech.jpg",desc="Technology"},
                  new grid_clas{image="Assets/business.jpg",desc="Bussiness"},
                 new grid_clas{image="Assets/space.jpg",desc="Space & Science" },
                  new grid_clas{image="Assets/sport.jpg",desc="Sports"},
                
                
                
            };
            global_scnd_grid.DataContext = m;
        }
        //end of 2nd grid

        //start of 3rd grid
        private void when_thrd_open(object sender, RoutedEventArgs e)
        {
            List<grid_clas> m = new List<grid_clas>()
            { new grid_clas{image="Assets/us.jpg",desc="U.S"},
                 new grid_clas{image="Assets/americas.jpg",desc="Americas"},
                  new grid_clas{image="Assets/asia.jpg",desc="Asia"},
                   new grid_clas{image="Assets/africa.jpg",desc="Africa"},
        };
            global_thrd_grid.DataContext = m;
        }
        //end of 3rd grid

        //start of 1st grid selection
        private void when_fst_select(object sender, SelectionChangedEventArgs e)
        {
        ...
        //end of 3rd grid selection

       //app bar button codes
