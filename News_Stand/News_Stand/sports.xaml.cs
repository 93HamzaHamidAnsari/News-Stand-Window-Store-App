...
namespace News_Stand
{
    ...
    public sealed partial class sports : Page
    {
        ...
        private void open(object sender, RoutedEventArgs e)
        {
            ...
            sports_storyboard.Begin();
            List<grid_clas> m = new List<grid_clas>()
            {
                new grid_clas{image="Assets/cri.jpg",desc="Cricket"},
                 new grid_clas{image="Assets/golf.jpg",desc="Golf"},
                 new grid_clas{image="Assets/Rugby_league.jpg",desc="Rugby League"},
                  new grid_clas{image="Assets/live_score.png",desc="Live Cricket Score"},
                 new grid_clas{image="Assets/snooker.jpg",desc="Snooker"},
                 new grid_clas{image="Assets/rugby.jpg",desc="Rugby Union"}, 
                  new grid_clas{image="Assets/fotbal.jpg",desc="Soccer" },
                 new grid_clas{image="Assets/f1.jpg",desc="Motorsport" },
                   new grid_clas{image="Assets/nba.jpg",desc="NBA/Basketball"},
                 new grid_clas{image="Assets/tenn.jpg",desc="Tennis"},
                  new grid_clas{image="Assets/mlb.png",desc="MLB/Baseball" },
                  new grid_clas{image="Assets/nhl.jpg",desc="NHL"},
                
            };
            sports_grid.DataContext = m;
           }
        //end of grid 
        ...
        private void when_select(object sender, SelectionChangedEventArgs e)
        {
            ...
            else if (des == "Live Cricket Score")
            {
