...
namespace News_Stand
{
    ...
    public sealed partial class entertainment : Page
    {
        ...
        private void open_holly(object sender, RoutedEventArgs e)
        {
            //grid of hollywood
            List<grid_clas> m = new List<grid_clas>()
            { new grid_clas{image="Assets/topst.jpg",desc="Top Stories"},
                 new grid_clas{image="Assets/latest_movie_news.jpg",desc="Latest Movies News"},
                  new grid_clas{image="Assets/review.jpg",desc="Movie Reviews"},
                   new grid_clas{image="Assets/release.jpg",desc="Upcoming Movies"},
        };
            holly_list.DataContext = m;
        }
        //end of hollywood grid

        //grid of bollywood
        private void open_bolly(object sender, RoutedEventArgs e)
        {
            List<grid_clas> m = new List<grid_clas>()
            { new grid_clas{image="Assets/topst.jpg",desc="Top Stories"},
                 new grid_clas{image="Assets/preview.jpg",desc="Movies Previews"},
                  new grid_clas{image="Assets/review.jpg",desc="Movie Reviews"},
                   new grid_clas{image="Assets/release.jpg",desc="Upcoming Movies"},
        };
            bolly_grid.DataContext = m;
        }
        //end of bollywood grid

        //grid of fashion
        private void open_fashion(object sender, RoutedEventArgs e)
        {
            List<grid_clas> m = new List<grid_clas>()
            { new grid_clas{image="Assets/fasio.jpg",desc="Top Stories"},
              new grid_clas{image="Assets/fas.jpg",desc="All Fashion"},
              new grid_clas{image="Assets/dres.jpg",desc="Dresses"}, 
              new grid_clas{image="Assets/hair.jpg",desc="Latest Hair Styles"}, 
              new grid_clas{image="Assets/general_hairs.jpg",desc="General Hair Styles"},
              new grid_clas{image="Assets/men_hairs.jpg",desc="Men's Hair Styles"},
              new grid_clas{image="Assets/fashion-and-beauty.jpg",desc="Beauty"}, 
              new grid_clas{image="Assets/shoes.jpg",desc="Footware"}, 
        };
            fashion_grid.DataContext = m;
        }
        //end of fashion grid
        ...
        {
            entertainment_storyboard.Begin();
        }
