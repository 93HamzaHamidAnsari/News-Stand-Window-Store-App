...
namespace News_Stand
{
    ...
    /// </summary>
    public sealed partial class news_stand : Page
    {
        public news_stand()
        {
        ...
        {
            news_stand_animationn.Begin();
           
            List<grid_clas> m = new List<grid_clas>()
            {
                new grid_clas{sub="Global News" ,image="Assets/globe.jpg"},
                new grid_clas{sub="Health News",image="Assets/health.jpg"},
                new grid_clas{sub="National News",image="Assets/national.jpg"},
                new grid_clas{sub="Education News",image="Assets/edu.jpg"},
                new grid_clas{sub="Sports News",image="Assets/spor.jpg"},
                new grid_clas{sub="Entertainment News",image="Assets/ent.jpg"},
                new grid_clas{sub="Weather News" ,image="Assets/weat.jpg"},
                new grid_clas{sub="Facts",image="Assets/facts.jpg"},
            };
            news_stand_grid.DataContext = m;
