...
namespace News_Stand
{
    ...
    /// </summary>
    public sealed partial class national : Page
    {
        public national()
        {
        ...
        private void open(object sender, RoutedEventArgs e)
        {
            ...
            { new grid_clas{image="Assets/pakistan.jpg",desc="Pakistan"},
                 
        };
         national_grid1.DataContext = m;
        }
        ...
        {
            List<grid_clas> m = new List<grid_clas>()
            { new grid_clas{image="Assets/uk.jpg",desc="U.K"},
                new grid_clas{image="Assets/us.jpg",desc="U.S"},
                  new grid_clas{image="Assets/arab.jpg",desc="Saudi Arab"},
                 
        };
            national_grid2.DataContext = m;
        }
        //end of 2nd grid
        ...
        {
            List<grid_clas> m = new List<grid_clas>()
            { new grid_clas{image="Assets/karachi.jpg",desc="Karachi"},
                new grid_clas{image="Assets/lahore.jpg",desc="Lahore"},
                new grid_clas{image="Assets/islamabad.jpg",desc="Islamabad"},
                new grid_clas{image="Assets/peshawar.jpg",desc="Peshawar"},
                new grid_clas{image="Assets/breaking.jpg",desc="India"},
                new grid_clas{image="Assets/gulf.jpg",desc="Gulf Countries"},
               
        };
            national_grid3.DataContext = m;
        }
        //end of 3rd grid

        
        //start of 1st grid selection
        private void when_select1(object sender, SelectionChangedEventArgs e)
        {
            Uri breaking = new Uri("http://feeds.feedburner.com/com/YEor");
            this.Frame.Navigate(typeof(national_rss), breaking);
       ...
       //app bar code
        ...
        {
            this.Frame.Navigate(typeof(national_rss));
        }
